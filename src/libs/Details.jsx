            ...
            <div className="md:flex-1 w-full">
              ...
              <div className="h-[150px] my-2 flex gap-5 overflow-auto">
                {imageIndex !== null && item && item.images && (
                  <img src={item.images[imageIndex]} alt="" />
                )}
                {imageIndex1 !== null && item && item.images && (
                  <img src={item.images[imageIndex1]} alt="" />
                )}
                {imageIndex2 !== null && item && item.images && (
                  <img src={item.images[imageIndex2]} alt="" />
                )}
                {imageIndex3 !== null && item && item.images && (
                  <img src={item.images[imageIndex3]} alt="" />
                )}
                {imageIndex4 !== null && item && item.images && (
                  <img src={item.images[imageIndex4]} alt="" />
                )}
              </div>
            </div>
            <div className="md:flex-1 w-full">
