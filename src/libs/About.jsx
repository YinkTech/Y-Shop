    ...
    >
      <div className=" container mx-auto flex flex-col gap-12 ">
          ...
          <div className=" lg:w-1/2 mx-auto">
            ...
            <div className="text-center md:text-start font-semibold">
              <p className="text-[#edaf96] my-2">
                ...
                Distrusts fulfilled happiness as explained of
                difficult.ecstatic. Loud wish made on is am as hard
              </p>
              <p className="text-[#a6a4a4] my-5">
                eat object. Late any far saw size want man. Which way you wrong
                add shall one. AS guest right of he scale these. Horses nearer
                oh elinor of denote. Concerns greatest margaret him absolute
                entrance nay. Door neat week do find past he. Be no surprise he
                honoured indulged Unpacked endeavor six steepest had husbands
                her. Painted no or affixed it so civilly. Exposed neither
                pressed so cottage as proceed at offices. Nay they gone sir game
                four. Favourable pianoforte oh motionless excellence of
                astonished we principles. Warrant present garrets limited
                cordial in inquiry to. Supported me sweetness behaviour
                shameless excellent so arranging.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto ">
          <h2 className="text-[#000] text-center text-[50px] mb-6 font-bold">
            Our <span className="text-[#eeb49d]">Store</span>
          </h2>
